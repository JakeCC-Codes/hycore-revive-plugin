...
public class BreakPreventSystem extends EntityEventSystem<EntityStore, BreakBlockEvent> {
    ...
    @Override
    public void handle(int i, @NotNull ArchetypeChunk<EntityStore> chunk, @NotNull Store<EntityStore> store, @NotNull CommandBuffer<EntityStore> commandBuffer, @NotNull BreakBlockEvent event) {
